...
var Level = Base.extend({
	...
	nextLoad: function() {
		...
		if (ended == true) {
			...
			alert("Congratulations Love!!!\nHappy 30th Birthday to the most amazing woman in the universe!!!\n" +
					"You are the Joy of My Life!!\nYou make me want to wake up every morning and continue living!!\n" +
					"You complete every facet on my life!\n" +
					"You are the reason to live. period.\n\n" +
					"... and now our vows, we have done a good job about them, we should always keep it that way :)\n" +
